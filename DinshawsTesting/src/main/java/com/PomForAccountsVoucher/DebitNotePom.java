...
public class DebitNotePom extends TBase {
	...
	public DebitNotePom(WebDriver Driver) {
	...
	public void SelectCreditToAccountDrop() throws InterruptedException {
		
		CreditToAccountDrop.click();
		
		Thread.sleep(500);
		
		SelectCreditToAcc.click();
